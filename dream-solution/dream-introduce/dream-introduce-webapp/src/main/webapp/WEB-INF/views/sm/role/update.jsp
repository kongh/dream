	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="sm-role-update-form" class="form-horizontal" role="form">
					<%--隐藏字段开始 --%>
					...
					<div class="form-group">
						<label for="sm-role-update-name" class="col-sm-2 control-label">角色名称</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="sm-role-update-name"
								name="name" placeholder="角色名称">
						</div>
					</div>
					<div class="form-group">
						<label for="sm-role-update-code" class="col-sm-2 control-label">角色编码</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="sm-role-update-code"
								name="code" placeholder="角色编码">
						</div>
					</div>
					<div class="form-group">
						<label for="sm-role-update-comments"
							class="col-sm-2 control-label">备注</label>
						<div class="col-sm-10">
							<textarea class="form-control" id="sm-role-update-comments"
